...
void controlManual(char c) {
  switch (c) {
    ...
    case 'i':
      subirBrazo();
      Serial.println("Subir brazo");
      break;
    case 'k':
      bajarBrazo();
      Serial.println("Bajar brazo");
      break;
    case 'j':
      abrirPinza();
    ...
    case 'b':
      detenerBrazo();
      Serial.println("Detener brazo");
      break;
    case 'p':
      detenerPinza();
      Serial.println("Detener pinza");
      break;
    default:
